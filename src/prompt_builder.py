...
class PromptResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Returns the result as a serializable dictionary."""
        return {
    ...
    def save_to_json(self, file_path: str) -> None:
        """Persists the trace result to a physical JSON file."""
        with open(file_path, 'w', encoding='utf-8') as f:
            json.dump(self.to_dict(), f, indent=4)
        logger.info(f"Trace saved to JSON: {file_path}")

    def save_to_markdown(self, file_path: str) -> None:
        """Persists research results as a human-readable document."""
        md_content = f"""# UX Research Prompt Trace
## Methodology: {self.methodology} (v{self.template_version})
- **Timestamp**: {self.generation_timestamp}
- **Audit Hash**: `{self.trace_hash}`
...
```
---
*Generated by Study-Aware Prompt Builder (RUXAILAB)*
"""
        with open(file_path, 'w', encoding='utf-8') as f:
            f.write(md_content)
        logger.info(f"Trace saved to Markdown: {file_path}")
